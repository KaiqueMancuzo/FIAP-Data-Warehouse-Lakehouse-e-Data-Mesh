...
2. Primeiro vamos fazer o fork do repositório que contém os exercícios da disciplina. Acesse o link [fiap-cloud-based-analytics](https://github.com/vamperst/fiap-cloud-based-analytics)
